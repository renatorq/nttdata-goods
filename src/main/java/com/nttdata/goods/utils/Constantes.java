package com.nttdata.goods.utils;
...
public class Constantes {
    ...
    public static final String TIPO_OPERACION_AN="ANULACION";
    public static final String MOTIVO_RECHAZO_STOCK = "La Orden no puede generar stock debajo de cero";
    public static final String MOTIVO_RECHAZO_ARTICULO = "El Articulo no existe";
}
